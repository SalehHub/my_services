...
// var lightBgColor = "#" + (ServiceTheme.lightBgColor.value.toRadixString(16) );
// var lightRoadColor = "#" + (ServiceTheme.lightAccentColor.value.toRadixString(16));

// String lightMapStyle() => mapStyleLight(lightBgColor, lightRoadColor);

// var darkBgColor = "#" + (ServiceTheme.darkBgColor.value.toRadixString(16) );
// var darkRoadColor = "#" + (ServiceTheme.darkAccentColor.value.toRadixString(16) );
//
// String darkMapStyle() => mapStyleDark(darkBgColor, darkRoadColor);
//
String darkMapStyleStatic(darkBgColor,darkRoadColor) {
  // String darkBgColor = ("0x" + (ServiceTheme.darkBgColor.value.toRadixString(16))).replaceAll("0xff", "");
  // String darkRoadColor = ("0x" + (ServiceTheme.darkAccentColor.value.toRadixString(16))).replaceAll("0xff", "");
...
String lightMapStyleStatic(lightRoadColor) {
  // String lightRoadColor = ("0x" + ServiceTheme.lightAccentColor.value.toRadixString(16)).replaceAll("0xff", "");
...
String getMapImageFromLatLong(double lat, double lng, String googleMapKey, BuildContext context) {
  String style = isDark(context) ? darkMapStyleStatic(Theme.of(context).colorScheme.background,Theme.of(context).colorScheme.primary) : lightMapStyleStatic(Theme.of(context).colorScheme.primary);
