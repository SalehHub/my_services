...
final localizedLabels = <Locale, MyServicesLocalizationsData>{
  Locale.fromSubtags(languageCode: 'en'): const MyServicesLocalizationsData(
    ...
    dependsOnSystem: 'Depends on system',
    appTheme: 'App Theme',
    turkish: 'Turkish',
    spanish: 'Spanish',
    french: 'French',
    ...
    yes: 'Yes',
    areYouSureYouWantToCloseTheApp: 'Are you sure you want to close the app?',
    notificationsAreDisabledForThisApp: 'Notifications are disabled for this app',
  ...
  Locale.fromSubtags(languageCode: 'ar'): const MyServicesLocalizationsData(
    ...
    profile: 'ملفك الشخصي',
    thereAreNoDataYet: 'لايوجد بيانات الآن',
    appVersion: 'نسخة التطبيق',
    darkMode: 'الوضع المظلم',
    lightMode: 'الوضع النهاري',
    dependsOnSystem: 'حسب النظام',
    appTheme: 'الوان التطبيق',
    turkish: 'التركية',
    spanish: 'الاسبانية',
    french: 'الفرنسية',
    english: 'الانجليزية',
    ...
    yes: 'نعم',
    areYouSureYouWantToCloseTheApp: 'هل تريد الخروج من التطبيق؟',
    notificationsAreDisabledForThisApp: 'الاشعارات للتطبيق معطلة من إعدادات الجهاز',
  ...
  Locale.fromSubtags(languageCode: 'fr'): const MyServicesLocalizationsData(
    ...
    weAreSorryOurServersAreNotRespondingAtThisTimePleaseTryAgainLater: 'Nous sommes désolés, nos serveurs ne répondent pas pour le moment, veuillez réessayer plus tard',
    ...
    unblock: 'Débloquer',
    block: 'Bloc',
    noReviewsForThisAccountYetCheckBackLater: 'Aucune revue pour ce compte encore. Revenez plus tard',
    ...
    enterTheCodeSentToYourEmail: 'Entrez le code envoyé à votre e-mail',
    verifyYourEmail: 'Vérifiez votre e-mail',
    editProfile: 'Editer le profil',
    changePassword: 'Changer le mot de passe',
    newPassword: 'Nouveau mot de passe',
    sentToYourEmailCheckYourSpamFolder: 'Envoyé à votre e-mail (vérifiez votre dossier de spam)',
    recoveryCode: 'Code de récupération',
    sendRecoveryCode: 'Envoyer le code de récupération',
    makeSureItIsCorrectWeWillSendARecoveryCodeToIt: 'Assurez-vous que c\'est correct, nous y enverrons un code de récupération',
    ...
    makeSureItIsCorrectWeWillAskYouToConfirmItBySendingACodeToIt: 'Assurez-vous que c\'est correct. Nous vous demanderons de le confirmer en lui envoyant un code',
    email: 'E-mail',
    name: 'Nom',
    enterTheNameCorrectly: 'Entrez correctement le nom',
    ...
    yes: 'Oui',
    areYouSureYouWantToCloseTheApp: 'Êtes-vous sûr de vouloir fermer l\'application?',
    notificationsAreDisabledForThisApp: 'Les notifications sont désactivées pour cette application',
  ...
  Locale.fromSubtags(languageCode: 'es'): const MyServicesLocalizationsData(
    ...
    yourSuggestionToImproveTheApp: 'Tu sugerencia para mejorar la aplicación',
    yourSuggestion: 'Tu sugerencia',
    time: 'Tiempo',
    date: 'Fecha',
    only: 'solo',
    contactUs: 'Contáctenos',
    weAreSorryOurServersAreNotRespondingAtThisTimePleaseTryAgainLater: 'Lo sentimos, nuestros servidores no responden en este momento, inténtelo de nuevo más tarde',
    ...
    deleteYourAccountPermanently: 'Elimine su cuenta permanentemente',
    ...
    appleMaps: 'Mapas de manzana',
    googleMaps: 'mapas de Google',
    chooseMapApp: 'Elija la aplicación MAP',
    noResultTryWithDifferentWords: 'Sin resultado, intente con diferentes palabras.',
    ...
    checkYourJunkOrSpamFolder: 'Revise su carpeta de basura o spam',
    ...
    sentToYourEmailCheckYourSpamFolder: 'Enviado a su correo electrónico (consulte su carpeta de spam)',
    recoveryCode: 'Código de recuperación',
    sendRecoveryCode: 'Enviar código de recuperación',
    makeSureItIsCorrectWeWillSendARecoveryCodeToIt: 'Asegúrese de que sea correcto, le enviaremos un código de recuperación',
    ...
    makeSureItIsCorrectWeWillAskYouToConfirmItBySendingACodeToIt: 'Asegúrese de que sea correcto. Le pediremos que lo confirme enviándole un código',
    email: 'Correo electrónico',
    name: 'Nombre',
    enterTheNameCorrectly: 'Ingrese el nombre correctamente',
    passwordLengthMustBeAtLeastCharacters: 'La longitud de la contraseña debe ser al menos 6 caracteres',
    ...
    profile: 'Perfil',
    thereAreNoDataYet: 'Todavía no hay datos',
    ...
    english: 'Inglés',
    arabic: 'Arábica',
    appLanguage: 'Lenguaje de aplicaciones',
    settings: 'Ajustes',
    updated: 'Actualizado',
  ...
  Locale.fromSubtags(languageCode: 'tr'): const MyServicesLocalizationsData(
    ...
    theCodeHasExpiredPleaseResendTheVerificationCodeToTryAgain: 'Kod süresi doldu. Tekrar denemek için lütfen doğrulama kodunu yeniden gönderin',
    ...
    searchByCountryNameOrDialCode: 'Ülke adına veya arama koduna göre arayın',
    ...
    markAllAsRead: 'Hepsini okuduğunu işaretle',
    ...
    delete: 'Silmek',
    avatar: 'Avatar',
    changeProfileImage: 'Profil Resimini Değiştir',
    ...
    makeSureItIsCorrectWeWillSendARecoveryCodeToIt: 'Doğru olduğundan emin olun, bir kurtarma kodu göndereceğiz',
    invalidRecoveryCode: 'Geçersiz Kurtarma Kodu',
    hello: 'Merhaba',
    yourNotifications: 'Senin Bildirimlerin',
    logoutAllDevices: 'Tüm cihazları oturum açın',
    logout: 'Çıkış Yap',
    ...
    passwordLengthMustBeAtLeastCharacters: 'Parola uzunluğu en az 6 karakter olmalı',
    ...
    toEnjoyLatestFeaturesPleaseUpdate: 'En son özelliklerin tadını çıkarmak için lütfen güncelleyin',
    newAppVersionIsAvailable: 'Yeni uygulama sürümü mevcuttur',
    newVersion: 'Yeni sürüm',
    yes: 'Evet',
    areYouSureYouWantToCloseTheApp: 'Uygulamayı kapatmak istediğinden emin misiniz?',
    notificationsAreDisabledForThisApp: 'Bu uygulama için bildirimler devre dışı bırakıldı',
    anErrorOccurredPleaseTakeAScreenshotAndContactUs: 'Bir hata oluştu. Lütfen bir ekran görüntüsü alın ve bizimle iletişime geçin',
  ),
};
...
class MyServicesLocalizationsData {
  const MyServicesLocalizationsData({
    ...
    required this.sendRecoveryCode,
    ...
    required this.thereAreNoDataYet,
    required this.appVersion,
    required this.darkMode,
    required this.lightMode,
    required this.dependsOnSystem,
    ...
    required this.yes,
    required this.areYouSureYouWantToCloseTheApp,
    required this.notificationsAreDisabledForThisApp,
  ...
  final String thereAreNoDataYet;
  final String appVersion;
  final String darkMode;
  final String lightMode;
  final String dependsOnSystem;
  ...
  final String yes;
  final String areYouSureYouWantToCloseTheApp;
  ...
  factory MyServicesLocalizationsData.fromJson(Map<String, Object?> map) => MyServicesLocalizationsData(
        ...
        sendRecoveryCode: map['sendRecoveryCode']! as String,
        ...
        thereAreNoDataYet: map['thereAreNoDataYet']! as String,
        appVersion: map['appVersion']! as String,
        darkMode: map['darkMode']! as String,
        lightMode: map['lightMode']! as String,
        dependsOnSystem: map['dependsOnSystem']! as String,
        ...
        areYouSureYouWantToCloseTheApp: map['areYouSureYouWantToCloseTheApp']! as String,
        notificationsAreDisabledForThisApp: map['notificationsAreDisabledForThisApp']! as String,
        anErrorOccurredPleaseTakeAScreenshotAndContactUs: map['anErrorOccurredPleaseTakeAScreenshotAndContactUs']! as String,
      );
  ...
  MyServicesLocalizationsData copyWith({
    ...
    String? newAccount,
    String? profile,
    String? thereAreNoDataYet,
    String? appVersion,
    String? darkMode,
    String? lightMode,
    String? dependsOnSystem,
    String? appTheme,
    String? turkish,
    String? spanish,
    String? french,
    ...
    String? newVersion,
    String? yes,
    String? areYouSureYouWantToCloseTheApp,
    String? notificationsAreDisabledForThisApp,
    String? anErrorOccurredPleaseTakeAScreenshotAndContactUs,
      ...
      MyServicesLocalizationsData(
        ...
        sendRecoveryCode: sendRecoveryCode ?? this.sendRecoveryCode,
        ...
        thereAreNoDataYet: thereAreNoDataYet ?? this.thereAreNoDataYet,
        appVersion: appVersion ?? this.appVersion,
        darkMode: darkMode ?? this.darkMode,
        lightMode: lightMode ?? this.lightMode,
        dependsOnSystem: dependsOnSystem ?? this.dependsOnSystem,
        ...
        yes: yes ?? this.yes,
        areYouSureYouWantToCloseTheApp: areYouSureYouWantToCloseTheApp ?? this.areYouSureYouWantToCloseTheApp,
        notificationsAreDisabledForThisApp: notificationsAreDisabledForThisApp ?? this.notificationsAreDisabledForThisApp,
        anErrorOccurredPleaseTakeAScreenshotAndContactUs: anErrorOccurredPleaseTakeAScreenshotAndContactUs ?? this.anErrorOccurredPleaseTakeAScreenshotAndContactUs,
      );
  ...
  bool operator ==(Object other) =>
      ...
      (other is MyServicesLocalizationsData &&
          ...
          sendRecoveryCode == other.sendRecoveryCode &&
          ...
          thereAreNoDataYet == other.thereAreNoDataYet &&
          appVersion == other.appVersion &&
          darkMode == other.darkMode &&
          lightMode == other.lightMode &&
          dependsOnSystem == other.dependsOnSystem &&
          ...
          yes == other.yes &&
          areYouSureYouWantToCloseTheApp == other.areYouSureYouWantToCloseTheApp &&
          notificationsAreDisabledForThisApp == other.notificationsAreDisabledForThisApp &&
          anErrorOccurredPleaseTakeAScreenshotAndContactUs == other.anErrorOccurredPleaseTakeAScreenshotAndContactUs);
  @override
  int get hashCode =>
      ...
      newAccount.hashCode ^
      profile.hashCode ^
      thereAreNoDataYet.hashCode ^
      appVersion.hashCode ^
      darkMode.hashCode ^
      lightMode.hashCode ^
      dependsOnSystem.hashCode ^
      appTheme.hashCode ^
      turkish.hashCode ^
      spanish.hashCode ^
      french.hashCode ^
      ...
      newVersion.hashCode ^
      yes.hashCode ^
      areYouSureYouWantToCloseTheApp.hashCode ^
      notificationsAreDisabledForThisApp.hashCode ^
      anErrorOccurredPleaseTakeAScreenshotAndContactUs.hashCode;
}
