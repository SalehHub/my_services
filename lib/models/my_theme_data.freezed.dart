...
mixin _$MyThemeData {
  ...
  @JsonKey(ignore: true)
  $MyThemeDataCopyWith<MyThemeData> get copyWith => throw _privateConstructorUsedError;
}
...
class _$_MyThemeData extends _MyThemeData {
  const _$_MyThemeData(
      ...
      this.onCard = Colors.green,
      this.error = const Color(0xffFFE5E5),
      this.onError = const Color(0xff750000),
      this.success = const Color(0xffDDFFD6),
      this.onSuccess = const Color(0xff175800),
      this.appBar})
      : super._();
